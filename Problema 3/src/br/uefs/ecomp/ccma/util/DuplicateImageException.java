...
/**
 * Classe de exceção responsável pelo erro de tentar inserir uma imagem que 
 * possui o mesmo nome de uma imagem que já está adicionada no sistema.
 *
...
public class DuplicateImageException extends Exception{
     ...
     * @return "Imagem já está adicionada no sistema!" caso aconteça a exceção.
     */
    @Override
    public String toString(){
        return "Imagem já está adicionada no sistema!";
    }
}
