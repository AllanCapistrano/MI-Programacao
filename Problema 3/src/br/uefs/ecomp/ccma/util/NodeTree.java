...
public class NodeTree {
    ...
    /** Método construtor utilizado na árvore AVL de imagens, que inicializa as
     * variáveis image, left, right e height.
     * 
     * @param image MedicalImage - Imagem que se deseja inserir na árvore.
     */
    public NodeTree(MedicalImage image){
        this.image = image;
        this.left = null;
        this.right = null;
        this.height = 1;
    ...
    /** Método que retorna a imagem que está em um nó da árvore de imagens.
     * 
     * @return MedicalImage - Imagem do nó desejado.
     */
    public MedicalImage getImage() {
        return image;
    }

    /** Método que modifica a imagem que está em um nó da árvore de imagens.
     * 
     * @param image MedicalImage - Imagem do nó desejado.
     */
    public void setImage(MedicalImage image) {
        this.image = image;
    }
